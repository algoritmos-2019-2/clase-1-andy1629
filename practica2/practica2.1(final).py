...
print("2 cuando pones el nombre y dos parentesis")

print("3 el enunciado es def y dos parentesis")

print("4 la funcion es el programa como tal, la llamada de funcion es cuando lo ejecutas")


print("5 puede a ver las variables que sean tanto globales como locales pero estas variables solo pueden ser una de estas")

print("6 todas las variables se convierten en variables locales")

print("7 la variable de retorno es para regresar inmediatamente a esta funcion y use la siguiente expresion como un valor de retorno")

print("8 no devuelve valores de la funcion")
print("9 le pones el nombre de la variable y antes de este global")
print("10 es el que sirve para inicilaizar una variable previa o para introduzir una variable como comodin")
print("11 la declaracion import random sirve para llamar la biblioteca con nombre random")
print("12 para llamar a esta funcion tenemos que poner random.randint(x,y)")
